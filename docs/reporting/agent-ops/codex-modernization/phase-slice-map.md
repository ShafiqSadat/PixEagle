...
| --- | --- | --- | --- |
| Phase 5 v7.2.0 WebRTC and release closure | software release gates complete; hardware/vehicle evidence remains separate | PXE-0170 done; PXE-0169 in progress | `checkpoints/2026-08-30-phase-5-v7.2.0-release-closure.md`; direct-public server STUN gathering is skipped while browser STUN, private/NAT STUN, and TURN remain intact. An independent remote Chrome 139 probe decoded advancing 640x480 WebRTC video for 22 seconds; answer generation dropped from about five seconds to about 6 ms and cleanup recorded 4.7 MB / 3,968 packets. Command preview now retains a bounded final no-PX4 summary. Focused backend `44`, Phase 0 `509`, dashboard `405`, schema, lint, build, compile, and diff gates pass. |
